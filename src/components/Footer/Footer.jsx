...
const Footer = () => {
  ...
  const navigation = {
    solutions: [
      ...
      { name: 'Catastrophic Injuries', href: '#' },
      { name: 'Family Law', href: '#' },
      { name: 'Medical Negligence', href: '#' },
      { name: 'Product Liability', href: '#' },
      { name: 'Premises Liability', href: '#' },
    ],
    support: [
      { name: 'Pricing', href: '#' },
  ...
  return (
    ...
    <footer className="bg-black ">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        ...
        <div
          className="mt-16 text-center flex justify-between items-center border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between"
        >
          <p className="text-md text-primary-500 sm:text-left">
            Copyright &copy; Kennedy Legal Team, 2023. All rights reserved.
          </p>
