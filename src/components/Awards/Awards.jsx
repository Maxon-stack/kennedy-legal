  ...
  return (
    <div className="bg-black">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-8 grid max-w-lg grid-cols-4 items-center gap-x-2 gap-y-5 sm:max-w-xl sm:grid-cols-5 sm:gap-x-3 lg:mx-0 lg:max-w-none lg:grid-cols-6 place-items-center justify-center ">
          {/* <img
